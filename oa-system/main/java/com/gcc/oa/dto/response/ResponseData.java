...
public class ResponseData implements Serializable {
    ...
    public void putException(Object value) {
        dataMap.put("exception", value);
    }
    ...
    /**
     * 不需要写错误码的自定义具体错误
     * 前面有几个错误异常的方法,对于今天的笔者来说有点冗余了,所以新定义一个方法,以后都用这个异常方法
     *
     * @param message
     * @return
     */
    public static ResponseData error(String message) {
        return new ResponseData(ExceptionCodeMessage.Code.OTHER_ERROR, message);
    }
}
